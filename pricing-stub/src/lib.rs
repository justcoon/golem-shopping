...
for SaveSnapshot {
    ...
    fn blocking_save(&self) -> Vec<u8> {
        let result = self
            .rpc
            .invoke_and_await("golem:pricing/save-snapshot.{save}", &[])
            .expect(
                &format!(
    ...
    fn save(
        ...
        let result = self
            .rpc
            .async_invoke_and_await("golem:pricing/save-snapshot.{save}", &[]);
        crate::bindings::exports::golem::pricing_stub::stub_pricing::FutureSaveResult::new(FutureSaveResult {
...
for LoadSnapshot {
    ...
    fn load(
        ...
        crate::bindings::exports::golem::pricing_stub::stub_pricing::FutureLoadResult::new(FutureLoadResult {
            future_invoke_result: result,
        })
    }
}
...
impl crate::bindings::exports::golem::pricing_stub::stub_pricing::GuestApi for Api {
    ...
    fn update_pricing(
        ...
        let result = self
            ...
            .expect(
                &format!(
                    "Failed to invoke remote {}", "golem:pricing/api.{update-pricing}"
                ),
            );
        ()
    }
