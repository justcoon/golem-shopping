    ...
    for FutureGetResult
{
    ...
    fn get(&self) -> Option<Option<crate::bindings::golem::product::api::Product>> {
        self.future_invoke_result.get().map(|result| {
            let result =
                result.expect(&format!("Failed to invoke remote {}", "golem:product/api.{get}"));
            (result
                .tuple_element(0)
...
impl crate::bindings::exports::golem::product_stub::stub_product::GuestApi for Api {
    ...
    fn blocking_get(&self) -> Option<crate::bindings::golem::product::api::Product> {
        let result = self
            ...
            .expect(&format!("Failed to invoke-and-await remote {}", "golem:product/api.{get}"));
    ...
    fn get(&self) -> crate::bindings::exports::golem::product_stub::stub_product::FutureGetResult {
        let result = self.rpc.async_invoke_and_await("golem:product/api.{get}", &[]);
        crate::bindings::exports::golem::product_stub::stub_product::FutureGetResult::new(
