        ...
        pub mod product_search_exports {
            ...
            pub mod api {
                ...
                pub unsafe fn _export_find_cabi<T: Guest>(
                    ...
                    let result2 = T::find(ProductFilter {
                        name: match arg0 {
                            0 => None,
                            1 => {
                                let e = {
                    ...
                    for (i, e) in vec13.into_iter().enumerate() {
                        let base = result13.add(i * 72);
                        {
                            ...
                            *base.add(12).cast::<usize>() = len6;
                            *base.add(8).cast::<*mut u8>() = ptr6.cast_mut();
                            let vec7 = (brand4.into_bytes()).into_boxed_slice();
                            let ptr7 = vec7.as_ptr().cast::<u8>();
                            let len7 = vec7.len();
                            ::core::mem::forget(vec7);
                            *base.add(20).cast::<usize>() = len7;
                            *base.add(16).cast::<*mut u8>() = ptr7.cast_mut();
                            let vec8 = (description4.into_bytes()).into_boxed_slice();
                            let ptr8 = vec8.as_ptr().cast::<u8>();
                            let len8 = vec8.len();
                            ...
                            *base.add(32).cast::<*mut u8>() = result10;
                            let super::super::super::super::wasi::clocks::wall_clock::Datetime {
                                seconds: seconds11,
                                nanoseconds: nanoseconds11,
                            } = created_at4;
                            *base.add(40).cast::<i64>() = _rt::as_i64(seconds11);
                            *base.add(48).cast::<i32>() = _rt::as_i32(nanoseconds11);
                            let super::super::super::super::wasi::clocks::wall_clock::Datetime {
                                seconds: seconds12,
                    ...
                    *ptr3.add(4).cast::<usize>() = len13;
                    *ptr3.add(0).cast::<*mut u8>() = result13;
                    ptr3
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_find<T: Guest>(arg0: *mut u8) {
                    ...
                    _rt::cabi_dealloc(base15, len15 * 72, 8);
                }
                pub trait Guest {
                    fn find(filter: ProductFilter) -> _rt::Vec<Product>;
                }
                #[doc(hidden)]
                macro_rules! __export_golem_product_search_exports_api_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "golem:product-search-exports/api#find"] unsafe extern "C" fn
                        export_find(arg0 : i32, arg1 : * mut u8, arg2 : usize, arg3 :
                        i32, arg4 : * mut u8, arg5 : usize,) -> * mut u8 {
                        $($path_to_types)*:: _export_find_cabi::<$ty > (arg0, arg1, arg2,
                        arg3, arg4, arg5) } #[export_name =
                        "cabi_post_golem:product-search-exports/api#find"] unsafe extern
                        "C" fn _post_return_find(arg0 : * mut u8,) { $($path_to_types)*::
                        __post_return_find::<$ty > (arg0) } };
                    };
                }
                #[doc(hidden)]
...
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x8c8\x01A\x02\x01A\x19\
...
t.schedule-save\x01?\x03\0#golem:product-client/product-client\x05\x0f\x01B\x0b\x02\
...
\x07product\x03\0\x03\x01ks\x01r\x02\x04name\x05\x05brand\x05\x04\0\x0eproduct-f\
ilter\x03\0\x06\x01p\x04\x01@\x01\x06filter\x07\0\x08\x04\0\x04find\x01\x09\x04\0\
\x20golem:product-search-exports/api\x05\x10\x04\0#golem:product-search/product-\
search\x04\0\x0b\x14\x01\0\x0eproduct-search\x03\0\0\0G\x09producers\x01\x0cproc\
